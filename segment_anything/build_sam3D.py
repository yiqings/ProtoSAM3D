...
from .modeling import ImageEncoderViT3D, MaskDecoder3D, MaskDecoder3D_without_prompt, PromptEncoder3D, Sam3D
...
def _build_sam3D(
    ...
    sam = Sam3D(
        ...
        mask_decoder_without_prompt=MaskDecoder3D_without_prompt(
            num_multimask_outputs=3,
            transformer_dim=prompt_embed_dim,
            iou_head_depth=3,
            iou_head_hidden_dim=256,
